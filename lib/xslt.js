...
(function(){
	 ...
	 * 
	 * Events: error, change, timeout, complete, transform
	 * 
	 */
	var TemplateLoader = function() {
		 ...
		 */
		this.addEventListener("complete", function createProcessor(event) {
	...
	function createSubTemplate(target, method) {
		...
		template.load(absolutePathFrom(origin, target));
